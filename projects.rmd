...
create_proj_card(
  ...
  text = "Combined original analysis of Economist Impact’s Global Food Security Index (GSFI) with insights from global experts to highlight challenges of and solutions for food insecurity.",
  text2 = NULL
)
